...
2. Before reviewing, call `team.get_gate` with the exact `intentId`, `risk`, and locked `baseCommit` from the IntentSpec. Never infer or downgrade these values from Agent Handoffs.
